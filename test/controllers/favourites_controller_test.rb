...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference("Favourite.count") do
      post favourites_url, params: { favourite: { embed_link: @favourite.embed_link, logged_user: @favourite.logged_user, string: @favourite.string, string,: @favourite.string,, title: @favourite.title, user_uid: @favourite.user_uid } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { embed_link: @favourite.embed_link, logged_user: @favourite.logged_user, string: @favourite.string, string,: @favourite.string,, title: @favourite.title, user_uid: @favourite.user_uid } }
